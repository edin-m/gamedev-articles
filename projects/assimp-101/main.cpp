...
int main(int argc, char** argv) {
  ...
  k::Shader shader;
  shader.loadShader("data/assimp-101/shaders/assimp-101");
  ...
  const char* sFilePath = "data/objects/suzanne.obj";
  ...
  k::GLTexture tex = textureLoader.loadTexture("data/images/texture.png");
